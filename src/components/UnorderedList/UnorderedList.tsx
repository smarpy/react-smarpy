...
import type UnorderedListProps from "./UnorderedListProps";
import type { BaseUnorderedListProps } from "./UnorderedListProps";

export default function UnorderedList<
  BaseComponentColorNameType extends string = ColorName,
  ComponentPropsType extends
    BaseUnorderedListProps<BaseComponentColorNameType> =
    UnorderedListProps<BaseComponentColorNameType>,
>(props: ComponentPropsType) {
  ...
  const assignedClassNames: string[] = [classNames["unordered-list"]];
  ...
  const gutterCss: Interpolation<Theme> = props.gutter
    ? {
        ["--smarpy-unordered-list-gutter-y"]:
