...
import classNames from "./SpeechBubble.module.scss";
import type { BaseSpeechBubbleProps } from "./SpeechBubbleProps";
import type SpeechBubbleProps from "./SpeechBubbleProps";

export default function SpeechBubble<
  BaseComponentColorNameType extends string = ColorName,
  ComponentPropsType extends BaseSpeechBubbleProps<BaseComponentColorNameType> =
    SpeechBubbleProps<BaseComponentColorNameType>,
>(props: ComponentPropsType): React.ReactElement {
  ...
  delete assignedProps["avatarHasBorder"];
  ...
  if (props.avatarHasBorder) {
    assignedClassNames.push(classNames[`avatar-has-border`]);
  }
