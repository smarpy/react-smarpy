...
export interface BaseSpeechBubbleProps<
...
type SpeechBubbleProps<BaseComponentColorNameType extends string> =
  ClassAttributes<HTMLDivElement> &
    HTMLAttributes<HTMLDivElement> &
    BaseSpeechBubbleProps<BaseComponentColorNameType>;
